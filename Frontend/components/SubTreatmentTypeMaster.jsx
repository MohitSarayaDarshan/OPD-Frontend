                  ...
                  <tr key={item.SubTreatmentTypeID} className="hover:bg-blue-50/30 transition-colors group">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        {/* EDIT ACTION */}
                        <Link to={`/admin/editSubTreatment/${item.SubTreatmentTypeID}`}>
                          <button className="p-1.5 hover:bg-blue-100 text-blue-600 rounded transition-all duration-300 hover:scale-110 active:scale-95" title="Edit">
                        ...
                        {/* DELETE ACTION */}
                        <button 
                          onClick={() => handleDelete(item.SubTreatmentTypeID)}
                          className="p-1.5 hover:bg-red-100 text-red-600 rounded transition-all duration-300 hover:scale-110 active:scale-95" 
                          title="Delete"
                        >
                          <Trash2 className="w-4 h-4" />
                        </button>
