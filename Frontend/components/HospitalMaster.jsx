        ...
        {filteredHospitals.map((hospital, index) => (
          ...
          >
            ...
            <div className="relative h-48 bg-gray-100 overflow-hidden">
              ...
              {/* Overlay Actions (Edit/Delete) - Only visible on hover/group-focus */}
              <div className="absolute top-3 right-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                 <Link to={`/admin/editHospital/${hospital.HospitalID}`}>
                   <button className="p-2 bg-white/90 hover:bg-white text-blue-600 rounded-full shadow-sm backdrop-blur-sm transition-all duration-300 hover:scale-110 active:scale-95" title="Edit">
                      <Edit2 className="w-4 h-4" />
                   </button>
                 </Link>
                 <button 
                    onClick={() => handleDelete(hospital.HospitalID)}
                    className="p-2 bg-white/90 hover:bg-white text-red-600 rounded-full shadow-sm backdrop-blur-sm transition-all duration-300 hover:scale-110 active:scale-95" 
                    title="Delete"
                 >
            ...
            <div className="p-5 flex-1 flex flex-col">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                ...
                <span className="inline-flex items-center px-2 py-1 bg-blue-50 text-blue-700 text-xs font-semibold rounded border border-blue-100">
                  <Clock className="w-3 h-3 mr-1" />
                  Valid: {hospital.RegistrationValidityMonths} Mo.
                </span>
              </div>
              ...
              <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                ...
                <Link to={`/admin/getHospital/${hospital.HospitalID}`}>
