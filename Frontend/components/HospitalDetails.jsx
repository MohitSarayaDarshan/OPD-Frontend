    ...
    <div className={`min-h-screen bg-gray-50 text-slate-800 font-sans p-8 ${expanded ? "ml-64" : "ml-16"} transition-all duration-1000`}>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">{hospitalList[id-101].HospitalName}</h1>
            <div className="flex items-center gap-2 text-slate-500 text-sm mt-1">
              <MapPin className="w-3.5 h-3.5" />
              <span>{hospitalList[id-101].Address}</span>
              <span className="mx-1">•</span>
              <span className="font-mono text-xs bg-blue-50 text-blue-700 px-2 py-0.5 rounded border border-blue-100">ID: {hospitalList[id-101].HospitalID}</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex gap-3">
          <button className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 text-slate-700 font-medium rounded-lg hover:bg-gray-50 transition-colors shadow-sm"
              onClick={()=>{
                setIndex(id-101)
                navigate(`/admin/editHospital/${id}`)
              }}>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl border border-blue-100 shadow-sm p-6">
            ...
            <p className="text-slate-600 leading-relaxed text-sm">
              {hospitalList[id-101].Description}
            </p>
          </div>
          ...
          <div className="bg-white rounded-xl border border-blue-100 shadow-sm p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                    ...
                    <div className="text-xl font-bold text-slate-900 mt-1">₹{hospitalList[id-101].RegistrationCharge}</div>
                </div>

                <div className="p-4 bg-gray-50 rounded-lg border border-gray-100">
                    <span className="text-xs text-slate-500 font-medium uppercase">Validity Period</span>
                    <div className="text-xl font-bold text-slate-900 mt-1">{hospitalList[id-101].RegistrationValidityMonths} Months</div>
                </div>

                <div className="flex items-center justify-between p-3 border border-gray-100 rounded-lg">
                    <span className="text-sm text-slate-600">Default Payment Mode ID</span>
                    <span className="font-mono font-bold text-slate-800">{hospitalList[id-101].DefaultPaymentModeID}</span>
                </div>

                <div className="flex items-center justify-between p-3 border border-gray-100 rounded-lg">
                    <span className="text-sm text-slate-600">Rate Enabled in Receipt</span>
                    {hospitalList[id-101].IsRateEnableInReceipt ? (
                ...
                <div className="flex items-center justify-between p-3 border border-gray-100 rounded-lg md:col-span-2">
                    ...
                    {hospitalList[id-101].IsRegistrationFeeEnableInOPD ? (
                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-center py-2 border-b border-gray-50">
                        ...
                        <div className="flex items-center gap-1.5 text-sm font-medium text-slate-800">
                            ...
                            {hospitalList[id-101].OpeningDate}
                        </div>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-gray-50">
                        <span className="text-sm text-slate-600">Patient No. Start</span>
                        <span className="font-mono font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded">{hospitalList[id-101].OpeningPatientNo}</span>
                    </div>
                    <div className="flex justify-between items-center py-2 border-b border-gray-50">
                        <span className="text-sm text-slate-600">OPD No. Start</span>
                        <span className="font-mono font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded">{hospitalList[id-101].OpeningOPDNo}</span>
                    </div>
                    <div className="flex justify-between items-center py-2">
                        <span className="text-sm text-slate-600">Receipt No. Start</span>
                        <span className="font-mono font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded">{hospitalList[id-101].OpeningReceiptNo}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl border border-gray-200 p-6">
                ...
                <ul className="space-y-3">
                    <li className="flex justify-between text-xs">
                        ...
                        <span className="font-mono text-slate-700">{hospitalList[id-101].UserID}</span>
                    </li>
                    <li className="flex justify-between text-xs">
                        <span className="text-slate-500">Created On</span>
                        <span className="text-slate-700">{hospitalList[id-101].Created}</span>
                    </li>
                    <li className="flex justify-between text-xs">
                        <span className="text-slate-500">Last Modified</span>
                        <span className="text-slate-700">{hospitalList[id-101].Modified}</span>
                    </li>
                </ul>
            </div>
