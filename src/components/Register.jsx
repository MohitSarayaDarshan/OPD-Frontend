...
const Register = () => {
    ...
    const handleRegister = async (e) => {
        ...
        try {
                ...
                const { agreeTerms, ...addData } = formData;
            ...
            <div className="bg-white w-full max-w-5xl rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row border border-blue-100 animate-scale-in">
                ...
                <div className="md:w-1/2 bg-indigo-600 relative p-10 flex flex-col justify-between text-white overflow-hidden animate-slide-right">
                    <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
                        ...
                        >
                            <path
                                d="M0 100 C 30 0 70 0 100 100 Z"
                                fill="white"
                            />
                        </svg>
                    </div>
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-indigo-100 text-lg">
                            Create your account to start managing patient
                            consultations, digital prescriptions, and hospital
                            workflows.
                        </p>
                    </div>
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-indigo-100">
                                    Your data is encrypted and follows global
                                    healthcare privacy standards (HIPAA
                                    compliant).
                                </p>
                            </div>
                        </div>
                ...
                <div className="md:w-1/2 p-10 flex flex-col justify-center animate-slide-left">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-500 text-sm mt-1">
                            Simple 2-step registration for new users.
                        </p>
                    </div>
                        ...
                        <div>
                            ...
                            {formData.Password.length > 0 &&
                                (() => {
                                    ...
                                    // Requirement: Digits + Char + Special Char
                                    const isComplex =
                                        hasLetters && hasNumbers && hasSpecial;

                                    return (
                                        <div className="mt-2 flex gap-1 h-1">
                                            {/* Segment 1: Basic Length Check */}
                                            <div
                                                className={`flex-1 rounded-full ${pwd.length > 4 ? "bg-orange-400" : "bg-red-400"}`}
                                            ></div>

                                            {/* Segment 3: Strong Length Check */}
                                            <div
                                                className={`flex-1 rounded-full ${hasMinLength ? "bg-emerald-400" : "bg-gray-200"}`}
                                            ></div>
                                            {/* Segment 2: Complexity Check (Digits + Char + Special) */}
                                            <div
                                                className={`flex-1 rounded-full ${isComplex && pwd.length > 8 ? "bg-emerald-600" : "bg-gray-200"}`}
                                            ></div>
                                        </div>
                                    );
                                })()}
