      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-blue-100 shadow-sm overflow-hidden animate-slide-down">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-gray-100 border-b border-gray-100">
            ...
            <QuickStat icon={<Phone className="text-green-500" />} label="Primary Mobile" value={patient.MobileNo} />
            <QuickStat icon={<Clock className="text-amber-500" />} label="Registered" value={patient.RegistrationDateTime}/>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-scale-in">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <DetailRow label="City / State" value={patient.CityID} />
                <DetailRow label="Pincode" value={patient.Pincode} />
                <DetailRow label="Emergency Contact" value={patient.EmergencyContactNo} highlight />
          ...
          <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
            ...
            <div className="space-y-6">
              <DetailRow label="Hospital ID" value={patient.HospitalID}/>
              <DetailRow label="Created By" value={patient.UserID} />
              <DetailRow label="Last Modified" value={patient.Modified} />
